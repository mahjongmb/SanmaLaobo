...
const CPU_OPEN_PROFILE_LIBRARY = {
  ...
  balanced: {
    ...
    riichiDangerPassBonus: 6.2,
    noValuePassBonus: 0.55,
    farShantenPassBonus: 0.6,
    topScorePassBonus: 1.2,

    ponYakuhaiBonus: 6.4,
    ponTenpaiKeepBonus: 4.6,
    ponShantenAdvanceBonus: 4.0,
    ponImproveCountFactor: 0.18,
    ponWaitTypeFactor: 0.12,
    ...
    ponToitoiBonus: 1.3,
    ponTanyaoBonus: 1.2,
    ponAlreadyOpenBonus: 1.55,
    ponDealerBonus: 1.0,
    ponRiichiDangerPenalty: 6.2,
    ponNoValuePenalty: 2.5,
    ponSpeedOnlyPenalty: 0.05,
    ponWorsenPenalty: 4.9,
    ponFarShantenPenalty: 2.0,
    ponTopScorePenalty: 1.0,
    ponSameTilePostcallPenalty: 1.8,
